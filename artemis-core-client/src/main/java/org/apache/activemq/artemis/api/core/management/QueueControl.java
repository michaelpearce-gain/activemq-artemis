...
public interface QueueControl {
   ...
   String sendTextMessage(@Parameter(name = "headers", desc = "The headers to add to the message") Map<String, String> headers,
                          @Parameter(name = "body", desc = "The body of the message as a String") String body,
