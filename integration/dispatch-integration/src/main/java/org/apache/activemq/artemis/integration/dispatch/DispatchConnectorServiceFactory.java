...
public class DispatchConnectorServiceFactory implements ConnectorServiceFactory
{
   @Override
   ...
   {
      return new DispatchConnectorService(configuration, postOffice, scheduledThreadPool);
   }

   @Override
   public Set<String> getAllowableProperties()
   {
      return DispatchConstants.ALLOWABLE_PROPERTIES;
   }

   @Override
   public Set<String> getRequiredProperties()
   {
      return DispatchConstants.REQUIRED_PROPERTIES;
   }
}
