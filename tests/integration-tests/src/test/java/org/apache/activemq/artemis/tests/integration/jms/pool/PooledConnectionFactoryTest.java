...
public class PooledConnectionFactoryTest extends JmsPoolTestSupport {
   ...
   public void testClearAllConnections() throws Exception {
      ...
      Assert.assertEquals(3, cf.getNumConnections());

      cf.clear();

      Assert.assertEquals(0, cf.getNumConnections());
   ...
   public void testFactoryStopStart() throws Exception {
      ...
      Assert.assertEquals(1, cf.getNumConnections());
   ...
   private void doTestConcurrentCreateGetsUniqueConnection(boolean createOnStart) throws Exception {
      ...
      try {
         ...
         final ConcurrentMap<String, Connection> connections = new ConcurrentHashMap<String, Connection>();
            ...
            executor.execute(new Runnable() {
               ...
               public void run() {
                  try {
                     ...
                     connections.put(amq.getUID().toString(), pooled);
                  } catch (JMSException e) {
                  }
               }
            });
