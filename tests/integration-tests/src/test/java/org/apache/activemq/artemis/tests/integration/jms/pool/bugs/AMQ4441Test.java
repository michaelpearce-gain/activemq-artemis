 ...
 */
package org.apache.activemq.artemis.tests.integration.jms.pool.bugs;
...
import org.apache.activemq.artemis.tests.integration.jms.pool.JmsPoolTestSupport;
import org.apache.activemq.artemis.tests.integration.jms.pool.PooledConnection;
import org.apache.activemq.artemis.tests.integration.jms.pool.PooledConnectionFactory;
...
public class AMQ4441Test extends JmsPoolTestSupport {
   ...
   public void demo() throws JMSException, InterruptedException {
      ...
      pooled.setConnectionFactory(new ActiveMQConnectionFactory("tcp://localhost:61616"));
